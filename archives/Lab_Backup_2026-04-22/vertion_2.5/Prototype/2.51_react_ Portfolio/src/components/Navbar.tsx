      ...
      <div className="max-w-[1600px] mx-auto px-6 h-20 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col leading-tight">
            <span className="font-headline font-black text-xl tracking-tighter text-white">SNORBIK</span>
            <span className="text-[10px] uppercase tracking-widest text-primary-container font-bold">
              Tayier NIMAIT - Expert IA
            </span>
          </div>
        </div>
        ...
        <div className="hidden lg:flex items-center gap-10">
          ...
          <button
            ...
            className="text-slate-400 hover:text-white transition-colors font-bold tracking-wide text-sm uppercase"
          >
            Projets
          </button>
          <button
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              href="#"
            >
              <svg className="w-4 h-4 fill-slate-400 group-hover:fill-primary-container" viewBox="0 0 24 24">
          ...
          <button className="w-9 h-9 flex items-center justify-center rounded-full bg-surface-container hover:bg-surface-container-high transition-colors">
            <span className="material-symbols-outlined text-[20px] text-primary-container">light_mode</span>
          </button>
